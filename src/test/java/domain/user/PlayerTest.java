...
class PlayerTest {
    ...
    @BeforeEach
    void setUp() {
        dealerCards = new Cards(newArrayList(new Card(Symbol.FIVE, Type.DIAMOND), new Card(Symbol.KING, Type.DIAMOND)));
    }
    ...
    void 딜러만_블랙잭일때_패배() {
        Cards dealerCards = new Cards(
                newArrayList(new Card(Symbol.ACE, Type.HEART), new Card(Symbol.KING, Type.DIAMOND)));
        Player player = new Player("pobi", 10000,
                newArrayList(new Card(Symbol.FIVE, Type.HEART), new Card(Symbol.QUEEN, Type.HEART)));
